...
KET_KNOWLEDGE_POINTS = [
    ...
    {"code": "KET-DIAG", "subject": "ket_english", "name": "KET入学诊断", "name_en": "KET Placement Test",
     "description": "英语水平测试，确定起始模块", "pillar": "diagnostic", "difficulty_level": 1, "amc_level": 0, "sort_order": 0, "estimated_minutes": 30},

    # Module A: Vocabulary
    {"code": "KET-VOC-01", "subject": "ket_english", "name": "高频日常词汇", "name_en": "High-Frequency Daily Vocabulary",
     "description": "KET核心词汇、场景分类、基础搭配", "pillar": "vocabulary", "difficulty_level": 1, "amc_level": 0, "sort_order": 1, "estimated_minutes": 20},
    {"code": "KET-VOC-02", "subject": "ket_english", "name": "数字/时间/日期", "name_en": "Numbers, Time and Dates",
     "description": "数字表达、时间读写、日期格式", "pillar": "vocabulary", "difficulty_level": 1, "amc_level": 0, "sort_order": 2, "estimated_minutes": 15},
    {"code": "KET-VOC-03", "subject": "ket_english", "name": "家庭/学校/食物", "name_en": "Family, School and Food",
     "description": "家庭成员、学科名称、食物饮品", "pillar": "vocabulary", "difficulty_level": 1, "amc_level": 0, "sort_order": 3, "estimated_minutes": 15},

    # Module B: Grammar
    {"code": "KET-GRAM-01", "subject": "ket_english", "name": "be动词/一般现在时", "name_en": "Be Verb & Present Simple",
     "description": "be动词变形、一般现在时、主谓一致", "pillar": "grammar", "difficulty_level": 2, "amc_level": 0, "sort_order": 4, "estimated_minutes": 25},
    {"code": "KET-GRAM-02", "subject": "ket_english", "name": "一般过去时/进行时", "name_en": "Past Simple & Present Continuous",
     "description": "规则/不规则动词过去式、现在进行时", "pillar": "grammar", "difficulty_level": 2, "amc_level": 0, "sort_order": 5, "estimated_minutes": 25},
    {"code": "KET-GRAM-03", "subject": "ket_english", "name": "疑问句/否定句", "name_en": "Questions & Negatives",
     "description": "一般疑问句、特殊疑问句、否定结构", "pillar": "grammar", "difficulty_level": 2, "amc_level": 0, "sort_order": 6, "estimated_minutes": 20},
    {"code": "KET-GRAM-04", "subject": "ket_english", "name": "介词/冠词", "name_en": "Prepositions & Articles",
     "description": "常用介词搭配、a/an/the用法", "pillar": "grammar", "difficulty_level": 2, "amc_level": 0, "sort_order": 7, "estimated_minutes": 20},
    {"code": "KET-GRAM-05", "subject": "ket_english", "name": "情态动词 (can/must)", "name_en": "Modal Verbs (can/must)",
     "description": "can/can't表能力、must/mustn't表义务", "pillar": "grammar", "difficulty_level": 2, "amc_level": 0, "sort_order": 8, "estimated_minutes": 20},

    # Module C: Reading
    {"code": "KET-READ-01", "subject": "ket_english", "name": "通知/标志理解", "name_en": "Understanding Notices & Signs",
     "description": "快速信息提取、图片+文字多选", "pillar": "reading", "difficulty_level": 2, "amc_level": 0, "sort_order": 9, "estimated_minutes": 25},
    {"code": "KET-READ-02", "subject": "ket_english", "name": "多文本匹配", "name_en": "Multiple Text Matching",
     "description": "扫读匹配、3段短文对应问题", "pillar": "reading", "difficulty_level": 2, "amc_level": 0, "sort_order": 10, "estimated_minutes": 25},
    {"code": "KET-READ-03", "subject": "ket_english", "name": "长文精读", "name_en": "Long Text Comprehension",
     "description": "分段阅读理解、主旨与细节", "pillar": "reading", "difficulty_level": 3, "amc_level": 0, "sort_order": 11, "estimated_minutes": 30},
    {"code": "KET-READ-04", "subject": "ket_english", "name": "完形填空技巧", "name_en": "Cloze Test Skills",
     "description": "语境词汇选择(Part 4)、语法填空(Part 5)", "pillar": "reading", "difficulty_level": 3, "amc_level": 0, "sort_order": 12, "estimated_minutes": 25},

    # Module D: Writing
    {"code": "KET-WRIT-01", "subject": "ket_english", "name": "邮件写作", "name_en": "Email Writing (Part 6)",
     "description": "邮件格式、3个要点覆盖、25词以上", "pillar": "writing", "difficulty_level": 2, "amc_level": 0, "sort_order": 13, "estimated_minutes": 25},
    {"code": "KET-WRIT-02", "subject": "ket_english", "name": "看图写故事", "name_en": "Picture Story Writing (Part 7)",
     "description": "图片描述、叙事连贯性、35词以上", "pillar": "writing", "difficulty_level": 3, "amc_level": 0, "sort_order": 14, "estimated_minutes": 25},
    {"code": "KET-WRIT-03", "subject": "ket_english", "name": "模拟写作 + AI评分", "name_en": "Mock Writing + AI Scoring",
     "description": "Content/Organisation/Language三维度评分", "pillar": "writing", "difficulty_level": 3, "amc_level": 0, "sort_order": 15, "estimated_minutes": 20},

    # Module E: Listening
    {"code": "KET-LIST-01", "subject": "ket_english", "name": "短对话理解", "name_en": "Short Dialogue Comprehension (Part 1)",
     "description": "短对话+图片选择、关键信息抓取", "pillar": "listening", "difficulty_level": 2, "amc_level": 0, "sort_order": 16, "estimated_minutes": 25},
    {"code": "KET-LIST-02", "subject": "ket_english", "name": "笔记填空", "name_en": "Note-Taking (Part 2)",
     "description": "独白信息提取、填入缺失信息", "pillar": "listening", "difficulty_level": 2, "amc_level": 0, "sort_order": 17, "estimated_minutes": 25},
    {"code": "KET-LIST-03", "subject": "ket_english", "name": "长对话", "name_en": "Long Dialogue (Part 3-4)",
     "description": "多段对话多选、信息匹配", "pillar": "listening", "difficulty_level": 3, "amc_level": 0, "sort_order": 18, "estimated_minutes": 25},
    {"code": "KET-LIST-04", "subject": "ket_english", "name": "匹配练习", "name_en": "Matching Practice (Part 5)",
     "description": "对话匹配、选项对应", "pillar": "listening", "difficulty_level": 3, "amc_level": 0, "sort_order": 19, "estimated_minutes": 20},

    # Module F: Speaking
    {"code": "KET-SPK-01", "subject": "ket_english", "name": "个人问答练习", "name_en": "Personal Q&A (Part 1)",
     "description": "自我介绍、个人信息问答(3-4分钟)", "pillar": "speaking", "difficulty_level": 2, "amc_level": 0, "sort_order": 20, "estimated_minutes": 25},
    {"code": "KET-SPK-02", "subject": "ket_english", "name": "讨论练习", "name_en": "Discussion Practice (Part 2)",
     "description": "图片讨论、表达观点与理由(5-6分钟)", "pillar": "speaking", "difficulty_level": 3, "amc_level": 0, "sort_order": 21, "estimated_minutes": 30},
    {"code": "KET-SPK-03", "subject": "ket_english", "name": "发音训练", "name_en": "Pronunciation Training",
     "description": "音素纠正、重音与语调、ASR反馈", "pillar": "speaking", "difficulty_level": 2, "amc_level": 0, "sort_order": 22, "estimated_minutes": 20},
    {"code": "KET-SPK-04", "subject": "ket_english", "name": "模拟口语考试", "name_en": "Mock Speaking Exam",
     "description": "完整模拟Part 1+Part 2，4维度评分", "pillar": "speaking", "difficulty_level": 3, "amc_level": 0, "sort_order": 23, "estimated_minutes": 20},
    ...
    {"code": "KET-MOCK-02", "subject": "ket_english", "name": "模拟口语考试", "name_en": "Mock Speaking Test",
     "description": "独立口语模拟，Band评分", "pillar": "mock_exam", "difficulty_level": 3, "amc_level": 0, "sort_order": 25, "estimated_minutes": 15},
    {"code": "KET-MOCK-03", "subject": "ket_english", "name": "弱项突破", "name_en": "Weakness Targeting",
     "description": "根据模拟成绩针对性补强", "pillar": "mock_exam", "difficulty_level": 3, "amc_level": 0, "sort_order": 26, "estimated_minutes": 30},
    {"code": "KET-MOCK-04", "subject": "ket_english", "name": "考试策略", "name_en": "Exam Strategies",
     "description": "时间管理、猜题技巧、常见陷阱", "pillar": "mock_exam", "difficulty_level": 2, "amc_level": 0, "sort_order": 27, "estimated_minutes": 20},
]
