...
export default function ListeningPage() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => api.get<KETQuestionListResponse>('/ket/questions', { skill: 'listening', limit: '20' }),
  });
  ...
  const handleAudioPlayed = (questionId: string) => {
    setQuizState((prev) => ({
      ...prev,
      audioPlayed: { ...prev.audioPlayed, [questionId]: true },
    }));
  };
    ...
    return (
      <div className="space-y-6">
        <div className="mx-auto max-w-3xl px-4 py-8">
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-12 dark:border-slate-700 dark:bg-slate-800">
            <Headphones className="h-16 w-16 text-slate-300 dark:text-slate-600" />
        ...
        <div className="mx-auto max-w-3xl px-4 py-8">
          ...
          <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
            <div className="mb-4 text-center">
              ...
              <p className="mt-2 text-5xl font-bold text-emerald-600 dark:text-emerald-400">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      optionClass,
                      !isCurrentSubmitted && 'hover:border-emerald-300 cursor-pointer',
          ...
          {isCurrentSubmitted && quizState.showExplanation[currentQuestion.id] && currentQuestion.explanation && (
            <div className="mt-6 rounded-xl border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-800 dark:bg-emerald-950">
              <p className="font-medium text-emerald-900 dark:text-emerald-100">解析</p>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          {!isCurrentSubmitted ? (
            <button
              ...
              className={cn(
                'rounded-xl bg-emerald-600 px-6 py-2 font-medium text-white transition-all',
