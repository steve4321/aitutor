    ...
    <div className="space-y-6">
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-12 dark:border-slate-700 dark:bg-slate-800">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-amber-50 dark:bg-amber-950">
            <Pen className="h-8 w-8 text-amber-600 dark:text-amber-400" />
          </div>
          <h2 className="mb-2 text-xl font-semibold text-slate-900 dark:text-white">写作评分功能开发中</h2>
          <p className="mb-8 text-center text-slate-500 dark:text-slate-400">
            AI 写作评分 pipeline 正在开发中<br />
            请稍后再来练习写作
          </p>
          <a
            href="/ket"
